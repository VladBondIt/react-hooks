...
export default class PostListItem extends Component {
    ...
    render() {
        const { label, onDelete, onLiked, onImportant, important, like } = this.props;
        ...
        return (
            <li className="postlist__item">
                <span onClick={onLiked} className={classNamesText}>{label}</span>
                <span className="postlist__btns">
                    <button onClick={onImportant} className="postlist__btn">
                    ...
                    <button onClick={onDelete} className="postlist__btn">
